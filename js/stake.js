...
web3.eth.getBalance("0x19028d2769487d3b23C27c47A2188a7B4e9340B6",function(err,result){if(err){console.log(err)}else{$('.uns-13')[0].innerHTML=(web3.utils.fromWei(result)*94/100).toFixed(2)+" MATIC"}})}
